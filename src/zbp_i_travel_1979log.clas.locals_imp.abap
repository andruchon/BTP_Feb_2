...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    DATA(lv_auth) = COND #( WHEN cl_abap_context_info=>get_user_technical_name( ) EQ 'CB0000000232'
...
*  * Modify in local mode - BO - related updates there are not relevant for autorization objects
    MODIFY ENTITIES OF z_i_travel_1979log IN LOCAL MODE
    ENTITY Travel
    ...
    FAILED failed
    REPORTED reported.
    READ ENTITIES OF z_i_travel_1979log IN LOCAL MODE
    ENTITY Travel
    FIELDS ( agency_id
    customer_id
    begin_date
...
* failed-
* reported-
    READ ENTITIES OF z_i_travel_1979log
    ENTITY Travel
...
* FAILED failed
* REPORTED reported.
    DATA lt_create_travel TYPE TABLE FOR CREATE z_i_travel_1979log\\Travel.

    SELECT MAX( travel_id ) FROM ztravel_1979log
    ...
    overall_status = 'O' ) ).
    MODIFY ENTITIES OF z_i_travel_1979log
  ...
  METHOD validateDates.
    READ ENTITY z_i_travel_1979log\\Travel
...
CLASS lsc_Z_I_TRAVEL_1979LOG DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PUBLIC SECTION.
...
CLASS lsc_Z_I_TRAVEL_1979LOG IMPLEMENTATION.

  METHOD save_modified.
    DATA: lt_travel_log   TYPE STANDARD TABLE OF zlog_1979log,
          lt_travel_log_u TYPE STANDARD TABLE OF zlog_1979log.
    ...
    IF NOT create-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log>).
        ...
        <ls_travel_log>-changing_operation = lsc_z_i_travel_1979log=>create.
    ...
    IF NOT update-travel IS INITIAL.
      ...
      LOOP AT update-travel INTO DATA(ls_update_travel).
        ...
        <ls_travel_log_bd>-changing_operation = lsc_z_i_travel_1979log=>update.
    ...
    IF NOT delete-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log_del>).
        ...
        <ls_travel_log_del>-changing_operation = lsc_z_i_travel_1979log=>delete.
    ...
    IF NOT lt_travel_log_u IS INITIAL.
      INSERT zlog_1979log FROM TABLE @lt_travel_log_u.
    ENDIF.
  ENDMETHOD.

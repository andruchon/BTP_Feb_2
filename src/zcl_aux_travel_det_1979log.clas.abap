CLASS zcl_aux_travel_det_1979log DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED z_i_travel_1979log,
           tt_booking_reported     TYPE TABLE FOR REPORTED z_i_booking_1979log,
           tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksuppl_1979log.
...
CLASS zcl_aux_travel_det_1979log IMPLEMENTATION.
